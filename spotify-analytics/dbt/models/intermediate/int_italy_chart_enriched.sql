...
select
    ...
    chart.streams::numeric / nullif(top_200_totals.top_200_streams, 0) as streams_share,
    case
    ...
    extract(year from track_details.album_release_date)::integer as release_year,
    chart.chart_date - track_details.album_release_date as days_since_release
from chart
