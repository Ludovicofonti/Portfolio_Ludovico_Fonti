...
renamed as (
    select
        ...
        cast(streams_change as bigint) as streams_change,
        cast(streams_7day as bigint) as streams_7day,
        cast(streams_7day_change as bigint) as streams_7day_change,
        cast(streams_total as bigint) as streams_total,
        kworb_track_url
    from source
)
